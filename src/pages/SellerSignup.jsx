...
const SellerSignup = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.farmName.trim()) {
      ...
      newErrors.farmName = 'Farm name must be less than 50 characters'
    }

    // Farm location validation
    if (!formData.farmLocation.trim()) {
      newErrors.farmLocation = 'Farm location is required'
    } else if (formData.farmLocation.length > 100) {
      newErrors.farmLocation = 'Farm location must be less than 100 characters'
    }
    ...
    <div className="auth-overlay">
      <div className="auth-container">
        <div className="auth-background">
          <img src="/src/assets/login_signup_images/seller signup page.png" alt="Seller Signup Background" className="background-image" />
