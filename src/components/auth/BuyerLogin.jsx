...
const BuyerLogin = ({ onAuthSuccess, onClose, onSwitchToSeller }) => {
      ...
      <div className="buyer-login-overlay">
        <div className="buyer-login-container">
          <div className="login-background">
            <img src="/src/assets/login_signup_images/buyer login page.png" alt="Buyer Login Background" className="background-image" />
      ...
      <div className="buyer-login-container">
        ...
        <div className="login-content">
          <div className="login-header">
            ...
            <div className="login-logo">
              <h1>🛒 Buyer Login</h1>
              <p>Access your shopping dashboard</p>
            </div>
          </div>

          <div className="login-switch">
            <button className="switch-btn active">Buyer Login</button>
            <button className="switch-btn" onClick={onSwitchToSeller}>Seller Login</button>
          </div>
