...
The frontend is configured to connect to the backend at `http://localhost:5001`. Update the `API_BASE_URL` in `src/services/authAPI.js` if needed.

## Testing the Application

1. **Start Backend**: Ensure the backend server is running on port 5001
